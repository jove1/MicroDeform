...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.LogKeyboard = QAction(MainWindow)
        self.LogKeyboard.setObjectName(u"LogKeyboard")
        self.LogKeyboard.setCheckable(True)
        ...
        self.menuLog.addAction(self.LogKeyboard)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LogKeyboard.setText(QCoreApplication.translate("MainWindow", u"Keyboard", None))
